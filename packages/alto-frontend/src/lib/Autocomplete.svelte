...
{#if mobileSearchScreen}
	<div class="fixed top-0 left-0 px-4 w-full h-full z-20 bg-white flex flex-col dark:text-black">
		<div class="flex items-center">
			...
			<button on:click={handleClose}>
				<Icon type="close" focusable fill={colors.black} height="32px" width="32px" />
			</button>
		</div>
		<hr />
		{#if filteredPlants.length > 0}
