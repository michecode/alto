  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="keywords"
          content={`Plant, Grow, Guide, Tutorial, How To, Learn, Care, Problems, calathea, calatheas`}
        />
        <meta name="description" content={`Alto's collection of calatheas`} />
        <meta name="viewport" content="width=device.width, initial-scale=1.0" />
        <title>Calathea Collection</title>
      </Helmet>
      <Container>
        <Title>Calatheas</Title>
        <TitleHelper>
...
export const query = graphql`
  query {
    allMongodbAltoDbPlants(filter: { classification: { eq: "Calathea" } }) {
      edges {
        node {
          classification
          mongodb_id
