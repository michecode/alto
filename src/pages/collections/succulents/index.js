  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="keywords"
          content={`Plant, Grow, Guide, Tutorial, How To, Learn, Care, Problems, Succulent, Succulents`}
        />
        <meta name="description" content={`Alto's collection of succulents`} />
...
export const query = graphql`
  query {
    allMongodbAltoDbPlants(filter: { classification: { eq: "Succulent" } }) {
      edges {
        node {
          classification
          mongodb_id
